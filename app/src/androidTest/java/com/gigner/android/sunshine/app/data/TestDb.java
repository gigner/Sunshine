 ...
 */
package com.gigner.android.sunshine.app.data;
...
public class TestDb extends AndroidTestCase
{
  ...
  */
  ...
  public long insertLocation()
  {
    ...
    final WeatherDbHelper weatherDbHelper = new WeatherDbHelper( mContext );
  ...
  public void testWeatherTable()
  {
    ...
    assertFalse("Error: Location Not Inserted Correctly", locationId == -1L);
    ...
    final ContentValues contentValues = TestUtilities.createWeatherValues( locationId );

    // Insert ContentValues into database and get a row ID back
    final long weatherRowId = db.insert( WeatherContract.WeatherEntry.TABLE_NAME,null, contentValues );
