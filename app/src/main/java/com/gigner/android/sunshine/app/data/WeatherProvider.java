...
//    );
  ...
  /*
      ...
      Returns mime types for the uri
   */
  @Override
  public String getType( Uri uri )
  {
    ...
    switch ( match )
    {
      ...
      case WEATHER_WITH_LOCATION_AND_DATE:
        return WeatherContract.WeatherEntry.CONTENT_ITEM_TYPE;  //item
      case WEATHER_WITH_LOCATION:
        return WeatherContract.WeatherEntry.CONTENT_TYPE; //dir
      case WEATHER:
        return WeatherContract.WeatherEntry.CONTENT_TYPE; //dir
      case LOCATION:
        return WeatherContract.LocationEntry.CONTENT_TYPE; //dir
      default:
                       ...
                       String sortOrder )
  {
    ...
    // vv important as it allows the ui to be notified when there is a change to the cursor/data
