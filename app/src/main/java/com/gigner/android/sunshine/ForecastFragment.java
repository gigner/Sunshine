  ...
  public boolean onOptionsItemSelected( MenuItem item )
  {
    ...
    switch ( item.getItemId() )
    {
      case R.id.action_refresh:
        new FetchWeatherTask().execute( "M503TW" );
        result = true;
        break;
      default:
  ...
  public class FetchWeatherTask extends AsyncTask<String, Void, String[]>
  {
    ...
    protected String[] doInBackground( final String... params )
    {
      ...
      try
      {
        ...
        final String uri = buildForcastUri( params[0], "metric", "7" );
        URL url = new URL( uri );
    ...
    private String buildForcastUri( final String postCode, final String unit, final String daysAhead)
    {
 ...
 */
          ...
          throws JSONException
  {
    ...
    final JSONArray days = json.getJSONArray( "list" );
    final JSONObject day = days.getJSONObject( dayIndex );
